...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/header/style/header.css"/>
    <!-- Custom Fonts -->
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <img alt="Hawklot" src="../headerhl.png" style="height:25px;">
                </a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <img alt="Hawklot" src="../headerhl.png">
                        <p class="intro-text">A parking rental service.
                            </p>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright &copy; HawkLot 2017</p>
        </div>
    </footer>
